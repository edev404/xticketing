...
@Component({
  selector: 'app-list-gray',
  templateUrl: './list-gray.component.html',
  styleUrls: ['./list-gray.component.scss']
})
export class ListGrayComponent implements OnInit {
  ...
  async loadData() {
    const resp = await this.api.getWithList(this.utils.getBasicEndPoint('greylist/refresh'));
